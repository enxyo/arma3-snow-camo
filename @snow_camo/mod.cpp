...
tooltipOwned = "Snow Camo by enxyo";
/// Color used for DLC stripes and backgrounds (RGBA)
dlcColor[] = {243, 141, 87, 1};
/// Overview text, displayed from the extension menu
overview = "Retextured arma 3 assets for arctic enviroment.";
